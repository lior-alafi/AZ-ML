...
ConfusionMatrixDisplay.from_estimator(decisionTree,xscaler.transform(x_test),y_test)
plt.show()
RocCurveDisplay.from_estimator(decisionTree,xscaler.transform(x_test),y_test)
plt.show()
...
pred_grid = decisionTree.predict(grid)
